...
- **Backup** (`BackupManager.buildBackupJson`) exports parents only; part rows and their analysis
  are not in the backup JSON and are lost on restore (they can be regenerated by re-analyzing).
